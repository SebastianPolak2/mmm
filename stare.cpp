...
int main()
{
    ...
    ofstream fileU("D:\\PROJECTS\\projekt_MMM\\mmm_cpp_proba_1\\fileUKozlowski.bin",ios::binary); // zapisanie wyników u(t) do pliku
    if (fileU.fail())
    {
    ...
    ofstream fileY("D:\\PROJECTS\\projekt_MMM\\mmm_cpp_proba_1\\fileYKozlowski.bin",ios::binary); // zapisanie wyników y(t) do pliku
    if (fileY.fail())
    {
